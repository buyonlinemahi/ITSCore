...
{
    internal class PatientContactedWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.PatientContacted //string.Empty //string.Format("Added new case id:{0}", CurrentCase.CaseID)
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.PatientContacted;
        }
    }
}
