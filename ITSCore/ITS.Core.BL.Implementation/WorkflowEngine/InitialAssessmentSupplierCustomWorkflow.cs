...
{
    internal class InitialAssessmentSupplierCustomWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.InitialAssessmentSupplierCustom
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.InitialAssessmentSupplierCustom;
        }
    }
}
