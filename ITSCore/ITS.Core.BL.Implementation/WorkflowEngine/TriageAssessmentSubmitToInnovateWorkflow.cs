...
{
    internal class TriageAssessmentSubmitToInnovateWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.TriageAssessmentSubmittedtoInnovate
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.TriageAssessmentSubmittedtoInnovate;
        }
    }
}
