...
{
    internal class RefertoSupplierWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReferredtoSupplier
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReferredtoSupplier;
        }
    }
}
