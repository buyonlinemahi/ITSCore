...
{
    internal class ReferralAcceptWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReferralAccepted
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReferralAccepted;
        }
    }
}
