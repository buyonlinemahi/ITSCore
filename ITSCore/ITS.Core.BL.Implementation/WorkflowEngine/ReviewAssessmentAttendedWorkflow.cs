...
{
    internal class ReviewAssessmentAttendedWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReviewAssessmentAttended
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReviewAssessmentAttended;
        }
    }
