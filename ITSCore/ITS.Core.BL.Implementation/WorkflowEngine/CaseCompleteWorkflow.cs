...
{
    internal class CaseCompleteWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.CaseCompleted
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.CaseCompleted;
        }
    }
}
