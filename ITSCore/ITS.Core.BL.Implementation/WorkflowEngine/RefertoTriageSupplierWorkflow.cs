...
{
    internal class RefertoTriageSupplierWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReferreredtoTriageSupplier
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReferreredtoTriageSupplier;
        }
    }
}
