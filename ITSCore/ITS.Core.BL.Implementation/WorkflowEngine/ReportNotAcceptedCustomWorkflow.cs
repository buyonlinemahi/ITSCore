...
{
    internal class ReportNotAcceptedCustomWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReportNotAcceptedCustom
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReportNotAcceptedCustom;
        }
    }
