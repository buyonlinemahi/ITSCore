...
{
    internal class ReviewAssessmentReportNotAcceptedCustomWorkflow : Workflow
    {
        public override CaseHistory History
        {
            get
            {
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReviewAssessmentReportNotAcceptedCustom
                };
            }
        }
        ...
        {
            return GlobalConst.WorkFlow.ReviewAssessmentReportNotAcceptedCustom;
        }
    }
