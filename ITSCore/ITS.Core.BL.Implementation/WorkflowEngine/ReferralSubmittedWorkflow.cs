...
{
    internal class ReferralSubmittedWorkflow : Workflow
    {
        public override int Run()
        {
            return GlobalConst.WorkFlow.ReferralSubmitted;
        }
        ...
        public override CaseHistory History
        {
            ...
            { 
                return new CaseHistory
                {
                    ...
                    UserID = UserID,
                    EventDescription = GlobalConst.WorkflowEventDescription.ReferralSubmitted
                }; 
            }
        }
    }
